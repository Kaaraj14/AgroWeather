...
var Wu = be(() => {
  ...
  Pl = "browser", Ol = "x64", xl = "browser", kl = { PATH: "/usr/bin", LANG: B.language + ".UTF-8", PWD: "/", HOME: "/home", TMP: "/tmp" }, Ml = ["/usr/bin/node"], Ll = [], Ul = "v16.8.0", Nl = {}, ql = function(t, e) {
    console.warn((e ? e + ": " : "") + t);
  }, Dl = function(t) {
    gs("binding");
  }, jl = function(t) {
...
var Sd = M((HP, Wo) => {
  ...
  m();
  _();
  typeof P > "u" || !P.version || P.version.indexOf("v0.") === 0 || P.version.indexOf("v1.") === 0 && P.version.indexOf("v1.8.") !== 0 ? Wo.exports = { nextTick: Cm } : Wo.exports = P;
  function Cm(t, e, r, i) {
    if (typeof t != "function")
...
var Yd = M((Bn) => {
  ...
  Bn.LRUCache = void 0;
  var Ai = typeof performance == "object" && performance && typeof performance.now == "function" ? performance : Date, Kd = /* @__PURE__ */ new Set(), ra = typeof P == "object" && P ? P : {}, Gd = (t, e, r, i) => {
...
var Zn = M((Bi) => {
  ...
  }, Bv = () => typeof B < "u" && B.product === "ReactNative", Pv = Cv() || Pp() || Bv();
  Bi.isWebWorker = Pp();
  Bi.default = Pv;
});
var xp = M((Rt) => {
